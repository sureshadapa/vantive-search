...
UserSearchString = '('+replace_all(UserSearchString, reps).lower()+").*"
...
print("Dumping data to NewIP_User_SearchResult_V3.csv");
# Open file to write search result data.
output_file = open('NewIP_User_SearchResult_V3.csv','w')

# Set header information of the CSV file
header_line = "Customer Unique Id,Account Number,Customer Status,Contact Name,Service Name,Billing Name,\
